    ...
    <div class="row">
        ...
        <div class="col-md-9 border-right" id="replace">
            <div class="p-3 py-5">
                ...
                <div class="row mt-3">
                    <div class="col-md-12"><label class="labels">Pass Word</label><input type="password" class="form-control" placeholder="Pass Word" value="${currentuser.getPass() }" name="password"></div>
                    <div class="col-md-12"><label class="labels">Re-Pass Word</label><input type="password" class="form-control" placeholder="Pass Word" value="${currentuser.getPass() }" name="repassword">
