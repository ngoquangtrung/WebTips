...
<div class="container rounded bg-white mt-5 mb-5">
    <div class="row">
        <div class="col-md-3 border-right">
        	...
        	<div class="row mt-2">
        		<div class="col-md-12 border-bottom"><p class="tabOption">Information</p> </div>
        		<div class="col-md-12 border-bottom"><p class="tabOption">Post</p> </div>
        		<div class="col-md-12 border-bottom"><p class="tabOption">Comment</p> </div>
        	</div>
        </div>
        ...
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-12"><label class="labels">Gender</label><input type="text" class="form-control" placeholder="enter address line 1" value=""></div>
