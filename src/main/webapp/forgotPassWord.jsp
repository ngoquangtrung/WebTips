...
<body>
  <div class="container">
            ...
            <form action="/GameRule/ForgotPassword" method="post">
              <div class="form-floating mb-3">
               <label for="floatingInput">Email address</label>
                ...
                <div class="alert-danger" role="alert">${usererror}</div>
              </div>            
              
              
              <div class="d-grid">
                <button class="btn btn-primary btn-login text-uppercase fw-bold" type="submit">Send mail </button>
              </div>
    ...
    &client_id=290818297744-pdh2mp1jckhb4bk82218kpc7s7g4i60k.apps.googleusercontent.com&approval_prompt=force" style="color:white">Sign in with Google</a>
                </p>
              </div>
              <div class="d-grid">
